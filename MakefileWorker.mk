...
ifeq ($(CPPUTEST_USE_VPATH), Y)
	...
	$(CPPUTEST_HOME)/$(CPPUTEST_SCRIPTS)/scripts/filterGcov.sh $(GCOV_OUTPUT) $(GCOV_ERROR) $(GCOV_REPORT) $(TEST_OUTPUT)
...
.PHONEY: format
format:
	$(CPPUTEST_HOME)/$(CPPUTEST_SCRIPTS)/scripts/reformat.sh $(PROJECT_HOME_DIR)
